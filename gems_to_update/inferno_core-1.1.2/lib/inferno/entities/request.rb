      ...
      class << self
        ...
        def from_http_response(response, test_session_id:, direction: 'outgoing', name: nil, tags: [])
          ...
          new(
            ...
            request_body: response.env.request_body&.encode('UTF-8', invalid: :replace, undef: :replace, replace: '?'),
        ...
        def from_fhir_client_reply(reply, test_session_id:, direction: 'outgoing', name: nil, tags: [])
          ...
          new(
            ...
            request_body: request_body&.encode('UTF-8', invalid: :replace, undef: :replace, replace: '?'),
            response_body: response[:body]&.encode('UTF-8', invalid: :replace, undef: :replace, replace: '?'),
            test_session_id:,
            headers: request_headers + response_headers,
            tags:
