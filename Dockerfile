...
COPY gems_to_update/inferno_core-0.6.17/lib/inferno/dsl/fhir_client_builder.rb /usr/local/bundle/gems/inferno_core-1.4.1/lib/inferno/dsl/fhir_client_builder.rb
COPY gems_to_update/inferno_core-0.6.17/lib/inferno/entities/input.rb /usr/local/bundle/gems/inferno_core-1.4.1/lib/inferno/entities/input.rb
COPY gems_to_update/fhir_client-6.0.0/lib/fhir_client/client.rb /usr/local/bundle/gems/fhir_client-6.2.0/lib/fhir_client/client.rb
...
COPY gems_to_update/inferno_core-1.1.2/lib/inferno/entities/request.rb /usr/local/bundle/gems/inferno_core-1.4.1/lib/inferno/entities/request.rb
